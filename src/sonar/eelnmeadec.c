...
static GstStaticPadTemplate gst_eelnmeadec_src_template =
...
static GstStaticPadTemplate gst_eelnmeadec_sink_template =
...
gst_eelnmeadec_transform (GstBaseTransform * basetransform, GstBuffer * in, GstBuffer * out)
{
...
static GstCaps *
gst_eelnmeadec_transform_caps (GstBaseTransform * basetransform, GstPadDirection direction, GstCaps * caps, GstCaps * filter)
{
  GstEelNmeaDec *eelnmeadec = GST_EEL_NMEA_DEC (basetransform);
...
static void
gst_eelnmeadec_set_property (GObject * object, guint prop_id, const GValue * value,
    GParamSpec * pspec)
{
...
static void
gst_eelnmeadec_get_property (GObject * object, guint prop_id, GValue * value,
    GParamSpec * pspec)
{
  GstEelNmeaDec *eelnmeadec = GST_EEL_NMEA_DEC (object);
...
static void
gst_eelnmeadec_finalize (GObject * object)
{
  GstEelNmeaDec *eelnmeadec = GST_EEL_NMEA_DEC (object);
...
static void
gst_eelnmeadec_class_init (GstEelNmeaDecClass * klass)
{
  ...
  gst_element_class_set_static_metadata (gstelement_class, "EelNmeaDec",
      "Transform",
      "parses telemetry data from custom nmea messages",
...
static void
gst_eelnmeadec_init (GstEelNmeaDec * eelnmeadec)
{
